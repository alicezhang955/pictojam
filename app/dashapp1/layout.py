...
layout = html.Div([
    ...
    html.P("PCA gives a linear representation of the data that captures the highest variation between points. ", style = {'font-size': '1rem'}),
    html.P("t-SNE is a nonlinear technique that makes sure close neighbors stay together from high dimension to low. ", style = {'font-size': '1rem'}),
    html.P("PHATE is a newer technique that's nonlinear like t-SNE, but pays more attention to far-away neighbors. ", style = {'font-size': '1rem'})
